  ...
  return (
    <div className=" flex flex-wrap items-center justify-center space-3">
      <div className="w-full mb-4">
        <h3 className="text-3xl text-center font-semibold">Tasks Status</h3>
        <Chart
          chartType="PieChart"
          data={taskStatusData}
      ...
      <div className="w-1/2">
        <h3 className="text-3xl text-center font-semibold">Workload</h3>
        <Chart
          chartType="BarChart"
          width="100%"
          height="500px"
      ...
      <div className="w-1/2">
        <h3 className="text-3xl text-center font-semibold">Task Lengths</h3>
        <Chart
          chartType="Bar"
          width="100%"
          height="500px"
